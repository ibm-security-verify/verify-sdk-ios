...
public struct UsernamePasswordEvaluation: FactorEvaluation {
    ...
    /// - parameter transactionId: Transaction identifier used to associate an evaluation.
    /// - parameter username: The username used for evaluation.
    /// - parameter password: The associated password for the username.
...
public struct OneTimePasscodeEvaluation: FactorEvaluation {
    ...
    /// - parameter transactionId: Transaction identifier used to associate an evaluation.
    /// - parameter code: The code generated from the seed.
    /// - parameter otp: The type of one-time passcode.
 ...
 public struct FIDOEvaluation: FactorEvaluation {
    ...
    /// Initializes a new instance of `OneTimePasscodeEvaluation`.
    /// - parameter transactionId: Transaction identifier used to associate an evaluation.
    /// - parameter clientDataJSON: A base64Url-encoded `clientDataJson` that was received from the WebAuthn client.
    /// - parameter authenticatorData: The information about the authentication produced by the authenticator and verified by the signature.
    /// - parameter userHandle: The identifier for the user who owns this authenticator.  It identifies the user to be logged in.
    /// - parameter signature: The base64Url-encoded bytes of the signature of the challenge data that was produced by the authenticator.
...
public struct QrCodeEvaluation: FactorEvaluation {
    ...
    /// Initializes a new instance of `OneTimePasscodeEvaluation`.
    /// - parameter transactionId: Transaction identifier used to associate an evaluation.
    /// - parameter accessToken: The access token associated with user.
...
public struct KnowledgeQuestionEvaluation: FactorEvaluation {
    ...
    public let answers: [String: String]
     ...
     /// Initializes a new instance of `OneTimePasscodeEvaluation`.
     /// - parameter transactionId: Transaction identifier used to associate an evaluation.
     /// - parameter answers: The dictionary of question keys and associated answers.
