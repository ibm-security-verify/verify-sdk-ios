...
public struct OIDCMetadataInfo: Decodable {
    ...
    var grant_types_supported: [String] = ["authorization_code", "implicit"]
    ...
    var id_token_encryption_alg_values_supported: [String] = ["none"]
    ...
    var id_token_encryption_enc_values_supported: [String] = ["none"]
    ...
    var userinfo_signing_alg_values_supported: [String] = ["none"]
    ...
    var userinfo_encryption_alg_values_supported: [String] = ["none"]
    ...
    var userinfo_encryption_enc_values_supported: [String] = ["none"]
    ...
    var request_object_signing_alg_values_supported: [String] = ["none"]
    ...
    var request_object_encryption_alg_values_supported: [String] = ["none"]
    ...
    var request_object_encryption_enc_values_supported: [String] = ["none"]
    ...
    var token_endpoint_auth_methods_supported: [String] = ["client_secret_basic"]
    ...
    @Default.False var claims_parameter_supported: Bool
    ...
    ///
    /// If omitted, the default value is `false`.
    @Default.False var request_parameter_supported: Bool
    ...
    @Default.True var request_uri_parameter_supported: Bool
    ...
    ///
    /// If omitted, the default value is `false`.
    @Default.False var require_request_uri_registration: Bool
