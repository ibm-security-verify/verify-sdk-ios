...
internal struct SecKeyStore {
    ...
    /// - parameter account: The account to store the key under in the key store.
    /// - parameter key: The key generated by the Secure Enclave in it raw representation.
    ...
    /// - parameter context: The Local Authentication context to associate with the key. Default is nil.
