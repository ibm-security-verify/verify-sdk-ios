...
public struct BasicAttestation: PackedAttestionStatementProvider {
    ...
    /// - parameter aaguid: The AAGUID of the authenticator.
    /// - parameter base64PrivateKey: A credential private key is the private key portion of a credential key pair.
    /// - parameter base64Certificate: The private certificate in privacy enhanced mail (PEM) format.
