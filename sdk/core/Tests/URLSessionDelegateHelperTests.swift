...
class URLSessionDelegateHelperTests: XCTestCase {
    ...
    func testSelfSignCertifcateValid() {
        // Given
        let url = URL(string: "https://jsonplaceholder.typicode.com/posts/1")!
        let expectation = self.expectation(description: "https://jsonplaceholder.typicode.com/posts/1")
    ...
    func testCertificatePinningInvalid() {
        // Given
        let url = URL(string: "https://jsonplaceholder.typicode.com/posts/1")!
        let expectation = self.expectation(description: "https://jsonplaceholder.typicode.com/posts/1")
