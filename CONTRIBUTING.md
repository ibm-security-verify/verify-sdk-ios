...
To generate the HTML docs for an SDK component, run `jazzy` in the directory containing the Xcode project file of the component. Then view the docs in the `verify-sdk-docs/ios/<component>/docs` directory:
